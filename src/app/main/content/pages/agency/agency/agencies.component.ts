...
export class agenciesComponent implements OnInit {
  ...
  inisilaize() {
    ...
    this.mainServ.APIServ.get("agencies").subscribe((data: any) => {
  ...
  deactivate(id) {
    ...
    this.translateService.get('MESSAGES.DEACTIVELOCATION').subscribe((res: string) => {
      this.dialogServ.confirmationMessage(res, "agencies/deactivate/" + id, {}, false, function () {
        mainThis.inisilaize()
      }, "delete")
    })
  }
  ...
  activate(id, name) {
    ...
    this.translateService.get('MESSAGES.ACTIVELOCATION').subscribe((res: string) => {
      this.dialogServ.confirmationMessage(res, "agencies/activate/" + id, {}, false, function () {
        mainThis.inisilaize()
      }, "put")
    })
  }
