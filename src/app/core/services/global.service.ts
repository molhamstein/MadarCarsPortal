...
export class GlobalService {
  ...
  constructor(private router: Router, private route: ActivatedRoute, public dialogServ:DialogService,public APIServe: CallApiService, public logInSer: LoginService) {
    this.notification = [];
    this.unreadNot = 0;
